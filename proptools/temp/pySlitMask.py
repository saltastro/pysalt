...
#        QtCore.QObject.connect(self.slitmask, SIGNAL('xmlloaded'), self.setcreator)
    ...
    def displayfootprint(self):
       ...
       fout.write('global color=red dashlist=8 3 width=1 font="helvetica 10 normal roman" select=0 highlite=0 dash=1 fixed=0 edit=0 move=0 delete=0 include=1 source=1\n')
       fout.write('fk5\n')
